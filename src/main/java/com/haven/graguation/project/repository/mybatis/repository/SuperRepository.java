package com.haven.graguation.project.repository.mybatis.repository;
...
public interface SuperRepository {
	 ...
	 * @return 成功返回查询结果
	 */
	List<Map<String, Object>> selectList(@Param("tableName") String tableName, @Param("condition") Map<String, Object> searchMap, @Param("orderBy") List<String> orderBy, @Param("offset") Long offset, @Param("rowCount") Long rowCount, @Param("queryColumns") String... selectColumns);
